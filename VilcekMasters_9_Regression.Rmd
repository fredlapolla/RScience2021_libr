...
This provides four charts:

>- Residuals vs. Fitted: This should look relatively randomly distributed and linear (the red line is straight). If it makes a shape like a parabola, linearity has not been met. 

>- QQ Plot: We can see if the residuals are normal or not. 

>- Scale Location/Spread Location: Here we test homoscedasticity, and if the dots are evenly spread around the line that is "good" (we have met our assumptions)

>- Residuals vs. Leverage: Here we see if there are influential outliers that may be skewing our results. It is often good to look into what is going on with outliers. They could be errors or they could hold new insights. We should look for cases in the upper right or lower right to see if there are influential cases. 
